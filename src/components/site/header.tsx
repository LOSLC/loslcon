...
export function Header() {
  ensureI18n();
  return (
    <header className="sticky top-0 z-40 w-full border-b border-white/10 bg-background/60 backdrop-blur-md supports-[backdrop-filter]:bg-background/40">
      <div className="container mx-auto max-w-6xl flex h-16 items-center justify-between px-4">
        ...
        <nav className="hidden md:flex items-center gap-3">
          ...
          <Link href="/devenir-sponsor" className="text-sm text-foreground/90 hover:text-foreground hidden sm:inline-block">
