        ...
        <div className="text-center mb-10 sm:mb-16">
          ...
          <Item>
            <p
              ...
              data-i18n="expect.subtitle"
            >
              Plongez dans un programme riche conçu pour tous les niveaux, des
              débutants aux experts confirmés.
            </p>
          </Item>
        </div>
                ...
                <Card className="group h-full bg-card/50 border-border/50 backdrop-blur hover:bg-card/80 transition-all duration-300 hover:shadow-2xl">
                  <CardContent className="p-8">
                    <div className="flex items-start gap-4">
                      <div
                        className={`p-4 rounded-2xl bg-background/50 text-primary group-hover:scale-110 transition-all duration-300 shadow-lg`}
                      >
                      ...
                      <div className="flex-1">
                        ...
                        <p
                          ...
                          data-i18n={`${item.i18n}_desc`}
                        >
                          {item.desc}
                        </p>
                        <div className="mt-4 flex items-center gap-2 text-xs sm:text-sm text-primary">
                          <CheckCircle2 className="h-4 w-4" />
                          <span data-i18n={`${item.i18n}_included`}>
                            Inclus dans votre ticket
                          </span>
                        </div>
                      </div>
                    </div>
            ...
            <div className="inline-flex flex-wrap justify-center items-center gap-4 sm:gap-8 p-4 sm:p-6 rounded-2xl bg-gradient-to-r from-primary/10 to-accent/10 border border-border/50 backdrop-blur">
              <div className="text-center">
                <div
                  ...
                  data-i18n="expect.schedule.morning"
                >
                  Matin
                </div>
                <div
                  className="text-sm text-muted-foreground"
                  data-i18n="expect.schedule.morning_desc"
                >
                  Conférences & Talks
                </div>
              </div>
              ...
              <div className="text-center">
                <div
                  className="text-2xl font-bold text-primary"
                  data-i18n="expect.schedule.afternoon"
                >
                  Après-midi
                </div>
                <div
                  className="text-sm text-muted-foreground"
                  data-i18n="expect.schedule.afternoon_desc"
                >
                  Ateliers & Networking
                </div>
              </div>
              ...
              <div className="text-center">
                <div
                  className="text-2xl font-bold text-primary"
                  data-i18n="expect.schedule.evening"
                >
                  Soirée
                </div>
                <div
                  className="text-sm text-muted-foreground"
                  data-i18n="expect.schedule.evening_desc"
                >
                  Networking & Clôture
                </div>
              </div>
