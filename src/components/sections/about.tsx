  ...
  return (
    <section className="relative py-24 overflow-hidden">
      ...
      <div aria-hidden className="absolute inset-0 -z-10">
        ...
        <div
          className="absolute right-1/4 bottom-1/4 h-80 w-80 rounded-full bg-accent/10 blur-3xl animate-pulse"
      ...
      <div className="container mx-auto max-w-6xl px-4">
        <div className="mx-auto max-w-4xl text-center mb-16">
          ...
          <Item>
            <p
              ...
              data-i18n="about.body"
            >
              LOSL-CON 2025 rassemble la communauté tech togolaise autour de la
              cybersécurité, l&#39;open source et Linux. Une journée
              d&#39;apprentissage, de networking et d&#39;innovation
              technologique.
            </p>
          </Item>
          <Item>
            <div className="mt-8 grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
              <div className="p-4 rounded-2xl bg-card/50 backdrop-blur border border-border/50">
                <div
                  ...
                  data-i18n="about.stats.speakers"
                >
                  5
                </div>
                <div
                  className="text-sm text-muted-foreground"
                  data-i18n="about.stats.speakers_label"
                >
                  Speakers experts
                </div>
              </div>
              <div className="p-4 rounded-2xl bg-card/50 backdrop-blur border border-border/50">
                <div
                  className="text-2xl font-bold text-primary"
                  data-i18n="about.stats.attendees"
                >
                  300–500
                </div>
                <div
                  className="text-sm text-muted-foreground"
                  data-i18n="about.stats.attendees_label"
                >
                  Participants
                </div>
              </div>
              <div className="p-4 rounded-2xl bg-card/50 backdrop-blur border border-border/50">
                <div
                  className="text-2xl font-bold text-primary"
                  data-i18n="about.stats.workshops"
                >
                  3
                </div>
                <div
                  className="text-sm text-muted-foreground"
                  data-i18n="about.stats.workshops_label"
                >
                  Ateliers pratiques
                </div>
              </div>
              <div className="p-4 rounded-2xl bg-card/50 backdrop-blur border border-border/50">
                <div
                  className="text-2xl font-bold text-primary"
                  data-i18n="about.stats.hours"
                >
                  8h
                </div>
                <div
                  className="text-sm text-muted-foreground"
                  data-i18n="about.stats.hours_label"
                >
                  De contenu
                </div>
              </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <Stagger className="space-y-6">
            ...
            ].map(({ Icon, titleKey, descKey, title, desc }) => (
              <Item key={titleKey}>
                <Card className="group border border-border/50 bg-card/30 backdrop-blur hover:bg-card/50 transition-all duration-300 hover:scale-105 hover:shadow-xl">
                  <CardHeader className="p-6">
                    <div className="flex items-start gap-4">
                      <div
                        className={`p-3 rounded-xl bg-background/50 text-primary group-hover:scale-110 transition-transform duration-300`}
                      >
          ...
          <Item>
            <div className="relative">
              ...
              <div className="relative rounded-2xl border-border/50 p-6">
                <Image
                  src="/event-cover.png"
                ...
                <div className="mt-6 text-center">
                  <h3
                    className="text-lg font-semibold mb-2"
                    data-i18n="about.event_info.title"
                  >
                    22 Novembre 2025
                  </h3>
                  <p
                    className="text-muted-foreground"
                    data-i18n="about.event_info.location"
                  >
                  ...
                  <div className="mt-4 flex items-center justify-center gap-4 text-sm">
                    <div className="flex items-center gap-2">
                      ...
                      <span data-i18n="about.event_info.networking">
                        Networking
                      </span>
                    </div>
                    <div className="flex items-center gap-2">
                      <Award className="h-4 w-4 text-primary" />
                      <span data-i18n="about.event_info.certificates">
                        Certificats
                      </span>
                    </div>
                  </div>
