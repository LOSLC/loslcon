// ISO 3166-1 alpha-2 country list (name + ISO2). Keep names in English for now.
// If you need localization, map display names externally.
...
export const COUNTRY_LIST: Country[] = [
  ...
  { iso2: "BT", name: "Bhutan" },
  { iso2: "BO", name: "Bolivia (Plurinational State of)" },
  ...
  { iso2: "TW", name: "Taiwan, Province of China" },
  ...
  { iso2: "VE", name: "Venezuela (Bolivarian Republic of)" },
