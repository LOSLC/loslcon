            ...
            >
              ...
              <CardContent className="flex grow flex-col">
                ...
                <div className="mt-4 flex flex-wrap gap-2 text-xs text-muted-foreground">
                  {isGold && (
                    <>
                      <span className="inline-flex items-center gap-1"><Megaphone className="h-3.5 w-3.5" /> <span data-i18n="sponsor.features.mediaBoost">Media boost</span></span>
                      <span className="inline-flex items-center gap-1"><Users className="h-3.5 w-3.5" /> <span data-i18n="sponsor.features.talentReach">Talent reach</span></span>
                      <span className="inline-flex items-center gap-1"><Mic2 className="h-3.5 w-3.5" /> <span data-i18n="sponsor.features.sceneTime">Scene time</span></span>
                    </>
                  )}
                </div>
